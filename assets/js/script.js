...
window.onload = function(){
  ...
  // added the currentDay and currentTime to the top of the page //
...
// added timeblocks to the time text area and added colors as the time is in the present, past or future //
